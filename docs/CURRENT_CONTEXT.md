...
- Current implementation ticket: GitHub issue `#409`, `KAN-118: Saved Period Compliance Report Profiles`, pending closure after final documentation evidence lands.
