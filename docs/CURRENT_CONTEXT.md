...
Updated: 2026-06-15
Ticket: `KAN-114` Period Compliance Report PDF export
...
- Current implementation branch: `product/KAN-114-period-compliance-report-pdf-export`.
- Current implementation ticket: GitHub issue `#396`, `KAN-114: Period Compliance Report PDF export`.
