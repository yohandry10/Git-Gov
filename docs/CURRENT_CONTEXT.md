...
Updated: 2026-06-15
Ticket: `KAN-116` Period Compliance Report provenance manifests
...
- Current implementation branch: `main` after KAN-116 merge.
- Current implementation ticket: GitHub issue `#402`, `KAN-116: Period Compliance Report Provenance Manifest`.
