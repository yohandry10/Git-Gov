...
- Current implementation branch: `product/KAN-118-period-report-profiles`.
- Current implementation ticket: GitHub issue `#409`, `KAN-118: Saved Period Compliance Report Profiles`.
