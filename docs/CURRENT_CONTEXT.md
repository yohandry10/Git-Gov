...
- Active implementation ticket: GitHub issue `#377`, `KAN-108: Tenant Auditor role for compliance evidence review`, on branch `product/KAN-108-tenant-auditor-rbac`.
