...
Updated: 2026-06-15
Ticket: `KAN-115` Period Compliance Report retention and export history
...
- Current implementation branch: `main` after KAN-115 merge.
- Current implementation ticket: GitHub issue `#399`, `KAN-115: Period Compliance Report Retention & Export History`.
