...
- Active implementation ticket: GitHub issue `#365`, `KAN-104: Framework pack review and provenance UX`, on branch `product/KAN-104-framework-pack-review-provenance-ux`.
