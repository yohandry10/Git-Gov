...
Updated: 2026-06-14
Ticket: `KAN-104` Framework Pack Review And Provenance UX
...
- Active implementation ticket: GitHub issue `#368`, `KAN-105: Framework-specific review report export`, on branch `product/KAN-105-framework-review-report-export`.
...
KAN-105 is locally complete and awaiting PR/check/merge/deploy validation. The next roadmap slice should not start until KAN-105 is merged and production-smoked.

Current work types are:

- KAN-105 PR publication, required checks, merge, Render deploy, production migration, and production smoke.
