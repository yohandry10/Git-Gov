...
| `KAN-35` | Reviewed workflow installation | Added a dry-run-first installer that applies CLI or dashboard workflow template packs into a local customer repository checkout only after explicit `-Apply`, with path validation and overwrite review. | Branch `product/KAN-35-reviewed-workflow-installation`, `scripts/control-plane/install_enterprise_workflow_templates.ps1`, `docs/design/reviewed-workflow-installation-mvp.md`, `docs/reports/reviewed-workflow-installation-2026-04-30.md` |
