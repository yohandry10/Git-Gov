...
| `KAN-36` | Provider connection validation | Added a secret-safe direct provider connection validator for adoption profiles, covering GitHub, Jira, Jenkins, SonarQube, Render, and Vercel with strict and report-only modes. | PR `#123`, branch `product/KAN-36-provider-connection-validation`, `scripts/control-plane/validate_enterprise_provider_connections.ps1`, `docs/design/provider-connection-validation-mvp.md`, `docs/reports/provider-connection-validation-2026-04-30.md` |
