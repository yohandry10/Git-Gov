...
- Active follow-up: `KAN-75 - Public web roadmap claims documentation audit`, which reconciles public docs and content architecture notes with implemented Jira, governance, Render production, risk-outcome, pricing, metadata, and web runtime facts while keeping `KAN-69` pending.
...
- Public web docs are being checked against `gitgov-web/package.json`, `gitgov-web/README.md`, bilingual public docs, `CONTENT_ARCHITECTURE_GUIDE.md`, and current product-state docs; corrected public claims include Next.js `15.5.15`, Jira operational maturity, governance blocking boundaries, Render-managed production, risk-outcome metrics, pricing/pilot-fit language, and stale `/docs/privacy` references.
