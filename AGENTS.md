...
- Product vulnerability trend ticket `KAN-27` adds `.github/workflows/product-vulnerability-review-trend-report.yml` and `scripts/control-plane/generate_product_vulnerability_review_trend_report.ps1` to build multi-run trend evidence from sanitized Product Vulnerability Review artifacts. Report: `docs/reports/product-vulnerability-review-trend-2026-04-30.md`. Local validation analyzed run `25157972836` and artifact `product-vulnerability-review-25157972836`, producing trend status `findings` with `5` pass, `1` expected finding, and `0` fail.
