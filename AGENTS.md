...
- Product roadmap after the security review is documented in `docs/design/enterprise-self-service-and-ai-copilot-roadmap.md`: the next product features are Enterprise Self-Service Adoption and Vercel AI SDK Copilot; KAN-28 is the immediate hardening step before starting those larger product builds.
