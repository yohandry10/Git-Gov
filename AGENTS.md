...
- Product vulnerability artifact monitor ticket `KAN-26` adds `.github/workflows/product-vulnerability-review-artifact-monitor.yml` to validate freshness of artifacts produced by `product-vulnerability-review.yml`. The shared artifact validator `scripts/control-plane/validate_github_evidence_report_artifact.ps1` now supports `-ArtifactNamePrefix`, used with prefix `product-vulnerability-review-`. Report: `docs/reports/product-vulnerability-review-artifact-monitor-2026-04-30.md`.
