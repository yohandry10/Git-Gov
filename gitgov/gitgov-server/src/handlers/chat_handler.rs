include!("chat_handler/helpers.rs");
include!("chat_handler/intent_short_circuit.rs");
include!("chat_handler/query_intro.rs");
include!("chat_handler/query_quality_gate.rs");
include!("chat_handler/query_release_readiness.rs");
include!("chat_handler/query_operational.rs");
include!("chat_handler/query_user_pushes.rs");
include!("chat_handler/query_user_identity.rs");
include!("chat_handler/query_commits.rs");
include!("chat_handler/ask.rs");

// -----------------------------------------------------------------------------
// Original chat_handler.rs migration archive (commented on purpose).
// The live implementation above is split into handlers/chat_handler/*.rs modules.
// Keep this commented archive only while validating the partition; delete it after
// the split is verified end-to-end.
// PART markers map archived source ranges to the new destination module.
// -----------------------------------------------------------------------------

// ===== PART 1 -> handlers/chat_handler/helpers.rs lines 1-311 =====
...
// }
//
// ===== PART 2 -> handlers/chat_handler/ask.rs setup/orchestrator lines 313-412 =====
...
//
// ===== PART 3 -> handlers/chat_handler/intent_short_circuit.rs lines 413-577 =====
//     match nlp.intent {
//         NlpIntent::TodoAdd => {
//             let text = nlp
//                 .entities
...
//     }
//
// ===== PART 4 -> handlers/chat_handler/ask.rs query routing setup lines 579-699 =====
//     if is_secret_exfiltration_request(&question) {
...
//
//     match query {
// ===== PART 5 -> handlers/chat_handler/query_intro.rs lines 701-1066 =====
...
//             );
//         }
// ===== PART 6 -> handlers/chat_handler/query_quality_gate.rs lines 1067-1798 =====
...
//             }
//         }
// ===== PART 7 -> handlers/chat_handler/query_release_readiness.rs lines 1799-2151 =====
...
//                             time_range_used: Some(format!("last_{}h", hours)),
//                             actions_recommended: vec![
//                                 "Priorizar repos con mayor tasa de FAIL en release readiness".to_string(),
//                                 "Revisar reasons/warnings del stage release_readiness en Jenkins".to_string(),
//                             ],
//                             confidence: Some(0.89),
//                             trace_id: None,
//                         },
...
//             }
//         }
// ===== PART 8 -> handlers/chat_handler/query_operational.rs lines 2152-2400 =====
...
//             }
//         },
// ===== PART 9 -> handlers/chat_handler/query_user_pushes.rs lines 2401-2846 =====
...
//             }
//         }
// ===== PART 10 -> handlers/chat_handler/query_user_identity.rs lines 2847-3108 =====
...
//             }
//         }
// ===== PART 11 -> handlers/chat_handler/query_commits.rs lines 3109-3494 =====
...
//             }
//         }
// ===== PART 12 -> archive gap / old match close lines 3495-3497 =====
//         None => {}
//     }
//
// ===== PART 13 -> handlers/chat_handler/ask.rs logs/knowledge/LLM fallback lines 3498-3795 =====
