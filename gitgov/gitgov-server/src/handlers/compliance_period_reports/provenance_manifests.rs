...
fn build_compliance_period_report_manifest_payload(
    ...
    json!({
        ...
        "period_report": {
            ...
            "reviewed_by_user_id": input.period_report.reviewed_by_user_id,
            "reviewed_at": input.period_report.reviewed_at,
            "has_review_notes_safe": input.period_report.review_notes_safe.is_some(),
        ...
        "audit_metadata": {
            ...
            "source_period_report_review_mutated": false,
