// Split facade for client event ingest, dashboard, and policy-check handlers.
// Live code is partitioned by responsibility under handlers/client_ingest_dashboard/.

include!("client_ingest_dashboard/ingest.rs");
...
// ============================================================================
// ARCHIVED ORIGINAL: src/handlers/client_ingest_dashboard.rs before SRP split.
// Keep temporarily as commented evidence until the split is reviewed and accepted.
// ============================================================================
// ===== PART 1 -> src/handlers/client_ingest_dashboard/ingest.rs lines 1-338 =====
// // ============================================================================
...
// }
//
// ===== PART 2 -> src/handlers/client_ingest_dashboard/outbox_lease.rs lines 339-529 =====
...
// }
//
// ===== PART 3 -> src/handlers/client_ingest_dashboard/cache.rs lines 530-989 =====
...
// }
//
// ===== PART 4 -> src/handlers/client_ingest_dashboard/dashboard_queries.rs lines 990-1395 =====
...
// }
//
// ===== PART 5 -> src/handlers/client_ingest_dashboard/policy_check.rs lines 1396-1886 =====
