...
pub use compliance::*;
pub use compliance_evidence_exports::*;
pub use compliance_evidence_mappings::*;
pub use compliance_framework_review_reports::*;
pub use compliance_review_packages::*;
pub use contracts::*;
pub use correlation::*;
pub use enterprise::*;
...
pub use health::*;
pub use identity_aliases::*;
pub use jira::*;
pub use legacy_audit::*;
pub use noncompliance::*;
...
// -----------------------------------------------------------------------------
// Original models.rs migration archive (commented on purpose).
// The live implementation above is split into models/*.rs modules. Keep this
// commented archive only while validating the partition; delete it after the
// split is verified end-to-end.
// PART markers map archived source ranges to the new destination module.
// Some archive gaps are wrapper/separator lines intentionally omitted from live
// modules, such as the old inline tests module wrapper.
// -----------------------------------------------------------------------------

//
// ===== PART 0 -> archive gap / separator lines 1-3 =====
// use serde::{Deserialize, Serialize};
// use std::collections::HashMap;
//
//
// ===== PART 1 -> src/models/organizations.rs lines 4-67 =====
// // ============================================================================
// // ORGANIZATIONS & REPOS
// // ============================================================================
//
...
//
//
// ===== PART 2 -> src/models/github_events.rs lines 68-158 =====
// // ============================================================================
...
//
//
// ===== PART 3 -> src/models/client_events.rs lines 159-300 =====
// // ============================================================================
...
// // ============================================================================
//
// ===== PART 4 -> src/models/violations.rs lines 301-339 =====
// // VIOLATIONS
// // ============================================================================
//
// #[derive(Debug, Clone, Serialize, Deserialize)]
...
// // ============================================================================
//
// ===== PART 5 -> src/models/stats.rs lines 340-449 =====
// // FILTERS & STATS
// // ============================================================================
//
...
// // ============================================================================
//
// ===== PART 6 -> src/models/policies.rs lines 450-557 =====
...
// // ============================================================================
//
// ===== PART 7 -> src/models/legacy_audit.rs lines 558-610 =====
...
// // ============================================================================
//
// ===== PART 8 -> src/models/auth_models.rs lines 611-648 =====
// // API KEYS
// // ============================================================================
//
// #[derive(Debug, Clone, Serialize, Deserialize)]
...
// // ============================================================================
//
// ===== PART 9 -> src/models/noncompliance.rs lines 649-772 =====
...
// // ============================================================================
//
// ===== PART 10 -> src/models/policy_changes.rs lines 773-835 =====
// // POLICY HISTORY
// // ============================================================================
//
// #[derive(Debug, Clone, Serialize, Deserialize)]
...
// // ============================================================================
//
// ===== PART 11 -> src/models/correlation.rs lines 836-860 =====
// // CORRELATION CONFIG
// // ============================================================================
//
// #[derive(Debug, Clone, Serialize, Deserialize)]
...
// // ============================================================================
//
// ===== PART 12 -> src/models/exports.rs lines 861-898 =====
// // EXPORT LOGS
// // ============================================================================
//
// #[derive(Debug, Clone, Serialize, Deserialize)]
...
// // ============================================================================
//
// ===== PART 13 -> src/models/compliance.rs lines 899-958 =====
...
// // ============================================================================
//
// ===== PART 14 -> src/models/health.rs lines 959-978 =====
// // SERVER HEALTH
// // ============================================================================
//
// #[derive(Debug, Clone, Serialize, Deserialize, utoipa::ToSchema)]
...
// // ============================================================================
//
// ===== PART 15 -> src/models/governance_events.rs lines 979-1034 =====
...
// // ============================================================================
//
// ===== PART 16 -> src/models/pipeline.rs lines 1035-1213 =====
...
// // ============================================================================
//
// ===== PART 17 -> src/models/jira.rs lines 1214-1377 =====
...
// // ============================================================================
//
// ===== PART 18 -> src/models/evidence_packets.rs lines 1378-1430 =====
...
//
//
// ===== PART 19 -> src/models/enterprise.rs lines 1431-1664 =====
// #[derive(Debug, Clone, Serialize, Deserialize)]
...
// // ============================================================================
//
// ===== PART 20 -> src/models/pull_requests.rs lines 1665-1740 =====
...
// // ============================================================================
//
// ===== PART 21 -> src/models/admin_audit.rs lines 1741-1776 =====
...
// // ============================================================================
//
// ===== PART 22 -> src/models/privacy.rs lines 1777-1795 =====
// // GDPR — T2
// // ============================================================================
//
// #[derive(Debug, Clone, Serialize, Deserialize)]
...
//
//
// ===== PART 23 -> src/models/sessions.rs lines 1796-1819 =====
// // ============================================================================
...
// // ============================================================================
//
// ===== PART 24 -> src/models/identity_aliases.rs lines 1820-1847 =====
...
// // ============================================================================
//
// ===== PART 25 -> src/models/org_users.rs lines 1848-1914 =====
// // ORG USERS (V1.4-A)
// // ============================================================================
//
// #[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
// // ============================================================================
//
// ===== PART 26 -> src/models/teams.rs lines 1915-1985 =====
...
// // ============================================================================
//
// ===== PART 27 -> src/models/org_invitations.rs lines 1986-2073 =====
...
// // ============================================================================
//
// ===== PART 28 (continuation) -> src/models/identity_aliases.rs lines 2074-2094 =====
...
//
//
// ===== PART 29 -> src/models/chat.rs lines 2095-2153 =====
// // ============================================================================
...
//
//
// ===== PART 30 -> src/models/contracts.rs lines 2154-2174 =====
...
// // ============================================================================
//
// ===== PART 31 -> archive gap / separator lines 2175-2179 =====
//
// #[cfg(test)]
// mod tests {
//     use super::*;
//
//
// ===== PART 32 -> src/models/tests.rs lines 2180-2592 =====
//     #[test]
...
//     }
//
// ===== PART 33 -> archive gap / separator lines 2593-2594 =====
// }
//
//
// ===== PART 34 -> src/models/cli_commands.rs lines 2595-2633 =====
// // ============================================================================
...
//
//
// ===== PART 35 -> src/models/policy_drift.rs lines 2634-2676 =====
// // ============================================================================
