export * from './useControlPlaneStore/types'
export { useControlPlaneStore } from './useControlPlaneStore/store'

// -----------------------------------------------------------------------------
// Original useControlPlaneStore.ts migration archive (commented on purpose).
// The live implementation above is split into store/useControlPlaneStore/*.ts modules.
...
// ===== PART 1 -> store/useControlPlaneStore/types.ts lines 1-707 =====
...
// }
//
// ===== PART 2 -> store/useControlPlaneStore/constants.ts lines 709-739 =====
...
// const DEFAULT_GOVERNANCE_LOG_WINDOW = 120
// const SSE_GOVERNANCE_LOG_WINDOW = 120
// const SSE_REFRESH_DEBOUNCE_MS = 1000
...
// ===== PART 3 -> store/useControlPlaneStore/helpers.ts mutable API-key cache line 740 and helper lines 742-1153, 1163-1329 =====
...
// ===== PART 4 -> store/useControlPlaneStore/store.ts in-flight guards lines 1154-1161 and store lines 1331-end =====
...
// let loadLogsIncrementalInFlight: Promise<void> | null = null
// let loadLogsIncrementalInFlightLimit = 0
// let lastHeavyDashboardRefreshAt = 0
// const initialChatState = readStoredChatState()
//
// ===== PART 5 -> store/useControlPlaneStore/helpers.ts chat persistence/config helpers lines 1163-1329 =====
...
// }
//
// ===== PART 6 -> store/useControlPlaneStore/store.ts Zustand implementation lines 1331-end =====
...
//     if (loadLogsIncrementalInFlight) {
//       const inFlightLimit = loadLogsIncrementalInFlightLimit
//       await loadLogsIncrementalInFlight
...
//     })()
//
//     loadLogsIncrementalInFlight = run
//     loadLogsIncrementalInFlightLimit = safeLimit
//     try {
//       await run
//     } finally {
//       if (loadLogsIncrementalInFlight === run) {
//         loadLogsIncrementalInFlight = null
