...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cmd_server_get_first_governed_repo_setup,
            commands::cmd_server_upsert_first_governed_repo_setup,
            commands::cmd_server_get_first_governed_repo_wizard_state,
            commands::cmd_server_create_first_governed_repo_wizard_run,
            commands::cmd_server_update_first_governed_repo_wizard_run,
            commands::cmd_server_validate_first_governed_repo_wizard_run,
            commands::cmd_server_plan_first_governed_repo_wizard_run,
            commands::cmd_server_complete_first_governed_repo_wizard_run,
            ...
            commands::cmd_server_get_multi_repo_executive_governance,
            commands::cmd_server_create_executive_governance_snapshot,
            commands::cmd_server_list_executive_governance_snapshots,
            commands::cmd_server_get_executive_governance_snapshot,
            commands::cmd_server_download_executive_governance_snapshot,
            commands::cmd_server_archive_executive_governance_snapshot,
            ...
            commands::cmd_server_create_change_risk_cab_decision_manifest,
            commands::cmd_server_list_change_risk_cab_decision_manifests,
            commands::cmd_server_get_change_risk_cab_decision_manifest,
            commands::cmd_server_download_change_risk_cab_decision_manifest,
            commands::cmd_server_revoke_change_risk_cab_decision_manifest,
            commands::cmd_server_create_compliance_evidence_export,
            commands::cmd_server_get_compliance_evidence_export,
            commands::cmd_server_download_compliance_evidence_export,
            commands::cmd_server_list_compliance_control_frameworks,
            ...
            commands::cmd_server_get_compliance_review_package,
            commands::cmd_server_download_compliance_review_package,
            ...
            commands::cmd_server_list_assigned_compliance_framework_review_reports,
            commands::cmd_server_list_compliance_framework_review_report_assignments,
            commands::cmd_server_upsert_compliance_framework_review_report_assignments,
            commands::cmd_server_list_compliance_framework_review_report_comments,
            ...
            commands::cmd_server_create_compliance_framework_review_report_pdf_export,
            commands::cmd_server_get_compliance_framework_review_report_pdf_export,
            commands::cmd_server_download_compliance_framework_review_report_pdf_export,
            commands::cmd_server_create_compliance_period_report,
            commands::cmd_server_list_compliance_period_reports,
            commands::cmd_server_create_compliance_period_report_profile,
            commands::cmd_server_list_compliance_period_report_profiles,
            commands::cmd_server_get_compliance_period_report_profile,
            commands::cmd_server_update_compliance_period_report_profile,
            commands::cmd_server_archive_compliance_period_report_profile,
            commands::cmd_server_run_compliance_period_report_profile,
            ...
            commands::cmd_server_create_compliance_period_report_share_package,
            commands::cmd_server_list_compliance_period_report_share_packages,
            commands::cmd_server_get_compliance_period_report_share_package,
            commands::cmd_server_download_compliance_period_report_share_package,
            commands::cmd_server_revoke_compliance_period_report_share_package,
